        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RTExpirationDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinanceExpense = table.Column<decimal>(type: "decimal(19,4)", nullable: false),
                    FinanceIncome = table.Column<decimal>(type: "decimal(19,4)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FoodId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(nullable: true),
                    FoodDateTime = table.Column<DateTime>(nullable: false),
                    FoodName = table.Column<string>(nullable: true),
                    FoodCalorie = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
